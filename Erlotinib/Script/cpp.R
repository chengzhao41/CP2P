...
if (exists("training_var_amount")) {
  save.image(paste0("erlotinib_cpp_", PARTITION_BEGIN, "to", PARTITION_END, "_", args[3], "_var", training_var_amount, ".RData"))  
} else {
  save.image(paste0("erlotinib_cpp_", PARTITION_BEGIN, "to", PARTITION_END, "_", args[3], ".RData"))  
}
