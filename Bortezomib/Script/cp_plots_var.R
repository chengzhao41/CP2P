...
for (temp.num in 3:30) {
  load(paste0("~/output_temp/Bortezomib/cp_var/", label.type, "/bortezomib_cp_1to100_", label.type, "_var", temp.num, ".RData"))   
  # Boxplot Data ---------------------------------
...
num_of_celllines = seq(30, 300, 10)
#save(cp.varying_training_matrix, num_of_celllines, file = paste0("cp_var_", label.type, ".RData"))
...
png(filename = paste0("bor_cp_var_", label.type, ".png"), width = 800, height = 800)
