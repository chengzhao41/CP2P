...
for (temp.num in 2:20) {
  load(paste0("~/output_temp/Docetaxel/cp_var/", label.type, "/docetaxel_cp_1to100_", label.type, "_var", temp.num, ".RData"))  
...
num_of_cell_lines = seq(40, 580, 30)
...
png(filename = paste0("doc_cp_var_", label.type, ".png"), width = 800, height = 800)
...
plot(0, 0, xlim = range(num_of_cell_lines), ylim = ylim, type = "n", 
     ...
     las = 1, cex.axis = 1.2, cex.lab = 1.5, yaxp = c(0.4, 1, 12), xaxp = c(40, 580, 18))
